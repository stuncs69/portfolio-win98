...
ZZZzz /,`.-'`'    -.  ;-;;,_
    ...
    '---''(_/--'  `-'\_)  asahi.zip
                ...
                <div class="contact-section">
                    <button
                        class="win98-button contact-button"
            ...
            <div class="win98-statusbar">
                ...
                <div class="win98-statusbar-section">
                    <a
                        class="win98-link"
                        href="https://github.com/stuncs69/portfolio-win98"
                        target="_blank"
                        >Source</a
                    >
                </div>
    ...
    data() {
        return {
            ...
            albums: [
                ...
                {
                    title: "when i was walking down the street...",
                    artist: "The L.B.",
                    image: "https://i.scdn.co/image/ab67616d00001e02ce2ddfbf0ad6e0c1c6a40ddf",
                    link: "https://open.spotify.com/album/0I3vj7wPMPaiPmpIMzXjM2?si=2xzrfaLfSI6A-zdSU4JJQw",
                },
                {
                    title: "Metaphor",
                    artist: "Ichika Nito",
            ...
            projects: [
                {
                    title: "SQLR",
                    description:
                        "SQLR is a simplistic and fast database engine and runtime built with Rust",
                    links: [
                        {
                            name: "GitHub",
                            url: "https://github.com/stuncs69/sqlr",
                        },
                    ],
                },
                {
                    ...
                    links: [
                        {
                            name: "GitHub",
                            url: "https://github.com/stuncs69/vexel",
                        },
                ...
                },
                {
                    title: "Tidepool",
                    description:
                        "TUI (Terminal user-interface) library for TypeScript.",
                    links: [
                        {
                            name: "GitHub",
                            url: "https://github.com/stuncs69/tidepool",
                        },
                        {
                            name: "NPM",
                            url: "https://www.npmjs.com/package/tidepool",
                        },
                    ],
                },
                {
                    title: "Papaya.js",
                    description:
                        "View-controller OOP backend framework for TypeScript.",
                    links: [
                        {
                            name: "GitHub",
                            url: "https://github.com/stuncs69/papaya.js",
                        },
                        {
                            name: "NPM",
                            url: "https://www.npmjs.com/package/papaya.js",
                        },
                    ],
                },
                {
                    ...
                    links: [{ name: "website", url: "https://mk.asahi.zip/" }],
                },
                {
                ...
                },
                {
                    title: "Custom bots",
                    description:
                        "I develop and maintain a few bots ranging from gateway systems to automatic chat moderation.",
                    links: [],
                },
            ] as Project[],
        };
